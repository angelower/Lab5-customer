...
import com.udea.lab5.customer.entity.DiscountCode;
 ...
 */
@Stateless
@Path("com.udea.lab5.customer.entity.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "com.udea_Lab5-customer_war_1.0-SNAPSHOTPU")
